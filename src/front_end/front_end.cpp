...
bool FrontEnd::InitWithConfig() {
    std::string config_file_path = "/home/jingwan/lidar_ws/src/lidar_test/config/FrontEndConfig.yaml";
...
bool FrontEnd::InitDataPath(const YAML::Node& config_node) {
    ...
    if (data_path_ == "./") {
        data_path_ ="/home/jingwan/lidar_ws/src/lidar_test";
    }
...
bool FrontEnd::GetCurrentScan(CloudData::CloudPtr& current_scan_ptr) {
